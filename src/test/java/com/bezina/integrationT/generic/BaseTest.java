package com.bezina.integrationT.generic;
...
public abstract class BaseTest {
    ...
    @Container
public static final GenericContainer<?> mongo = new GenericContainer<>("mongo")
    ...
    static void mongoProperties(DynamicPropertyRegistry registry){
       ...
       // registry.add("spring.data.mongodb.uri", () ->
        ...
        var mappedPort = mongo.getMappedPort(MONGO_PORT);
        registry.add("spring.data.mongodb.uri", () ->
                String.format("mongodb://job_user:job_password@localhost:%d/job", mappedPort));
    }
}
*/
@Testcontainers
public abstract class BaseTest {
    ...
    static void mongoProperties(DynamicPropertyRegistry registry){
        mongo.start();
        mongoUri = String.format(MONGO_URI_FORMAT, mongo.getHost(), mongo.getMappedPort(MONGO_PORT));
